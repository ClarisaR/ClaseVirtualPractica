...
public class PruebaReferencia {
	...
	public static void main(String[] args) {
		...
		//En la segunda comparacion utilizamos el metodo equals(), y el resultado es "Los textos son iguales", ya que, este metodo compara el contenidos de los objetos texto1 y texto2
	}
